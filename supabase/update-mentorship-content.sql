-- ============================================================
-- One-off backfill: Mentorship Program now shows the same
-- ESSENTIALS/EDGE/PRECISION curriculum as Guided Learning in its
-- "Enroll Now" popup. Safe to re-run (idempotent).
-- ============================================================
